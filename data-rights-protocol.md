...
- That the Authorized Agent attribute in the request matches the Authorized Agent identity outside the envelope (this is very important to prevent requests generated by one AA from being reused by another AA)
